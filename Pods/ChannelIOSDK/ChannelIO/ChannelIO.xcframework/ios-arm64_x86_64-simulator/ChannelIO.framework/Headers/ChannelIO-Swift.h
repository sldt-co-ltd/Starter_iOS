...
#ifndef CHANNELIO_SWIFT_H
#define CHANNELIO_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ChannelIO",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9ChannelIO10BootConfig")
...
SWIFT_CLASS("_TtC9ChannelIO19ChannelButtonOption")
...
SWIFT_CLASS("_TtC9ChannelIO9ChannelIO")
...
@interface ChannelIO (SWIFT_EXTENSION(ChannelIO))
@end

@class NSURL;

SWIFT_CLASS("_TtCC9ChannelIO9ChannelIO18CrossPlatformUtils")
...
SWIFT_PROTOCOL("_TtP9ChannelIO21ChannelPluginDelegate_")
@protocol ChannelPluginDelegate
@optional
...
SWIFT_CLASS("_TtC9ChannelIO21ChannelPluginSettings") SWIFT_DEPRECATED_MSG("", "BootConfing")
...
SWIFT_CLASS("_TtC9ChannelIO14LauncherConfig") SWIFT_DEPRECATED_MSG("", "_TtC9ChannelIO19ChannelButtonOption")
...
SWIFT_CLASS("_TtC9ChannelIO9PopupData")
...
SWIFT_CLASS("_TtC9ChannelIO7Profile")
...
SWIFT_CLASS("_TtC9ChannelIO9PushEvent") SWIFT_DEPRECATED_MSG("", "_TtC9ChannelIO9PopupData")
...
@interface UIPageControl (SWIFT_EXTENSION(ChannelIO))
- (void)sizeToFit;
@end
...
SWIFT_CLASS("_TtC9ChannelIO26UpdateUserParamObjcBuilder")
...
SWIFT_CLASS("_TtC9ChannelIO4User")
